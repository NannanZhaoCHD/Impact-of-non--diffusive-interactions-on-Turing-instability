...
end program FHN_multistability
...
real*8::c(n,n)
real*8::x,pp
real*8, parameter::sigma=0.1,p=0.1
    do i=1,n
        do j=1,n
            c(i,j)=0.0
        enddo 
